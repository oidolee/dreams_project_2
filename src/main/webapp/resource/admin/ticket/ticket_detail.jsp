...
//      let bgNormalPrice = document.getElementById("bgNormalPrice").value; // 일반등급 좌석
    ...
    <script>
		...
		$('#btnEdit').click(function(){
			...
			document.editForm.action="${path}/admin.tc"; 
				        ...
				        <div class="elements">
							...
							<table border="1" style="width: 416.55px;">
	                            ...
	                            <tr id="normal-price">
	                                ...
	                                <td><input id="changePrice-normal" name="changePrice-normal" type="text" style="width: 100px;" value="<%= tdto.getTicket_grade_normal() %>" onblur="calculator()">원</td>
	                            </tr>
	                            <tr>
	                                ...
	                                <td id="bgMPrice">0</td>
	                                <td>수정할 가격</td>
	                                <td><input id="changePrice-membership" name="changePrice-membership" type="text" style="width: 100px;" value="<%= tdto.getTicket_grade_membership() %>"  oninput="calculator()">원</td>
	                            </tr>
	                            <tr>
	                                <td>듬린이</td>
	                                <td id="bgCPrice">0</td>
	                                <td>수정할 가격</td>
	                                <td><input id="changePrice-child" name="changePrice-child" type="text"  style="width: 100px;" value="<%= tdto.getTicket_grade_child() %>"  oninput="calculator()">원</td>
	                            </tr>
	                            <tr>
