                    ...
                    <div class="top-box">
                        <div class="right">
                            <ul>
                                ...
                                <li><a href="/dreams_project_2/resource/page_1/customer/login/login.jsp">로그인</a></li>
                                <li><a href="/dreams_project_2/resource/page_1/customer/join/join.jsp">회원가입</a></li>
                        ...
                        <ul id="mo-menu-box" class="mo-menu-box">
                            <li style="position: relative;">
                                <div class="home-box">
                                    ...
                                    <a href="/dreams_project_2/resource/page_1/customer/login/login.jsp">로그인</a>
                                    <a href="/dreams_project_2/resource/page_1/customer/join/join.jsp">회원가입</a>
                                </div>
                            </li>
                            <li>
                                <a href="#">DREAMS</a>
